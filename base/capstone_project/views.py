...
from capstone_project.models import User, Council, Analytics
...
def sign_up(request):
    ...
    if request.method == 'POST':
        ...
        print(f"Received form data: full_name={full_name}, username={username}, email={email}, council_id={council_id}, age={age}, address={address}, contact_number={contact_number}")
